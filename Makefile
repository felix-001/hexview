#############################################################################
# Makefile for building: hexview.app/Contents/MacOS/hexview
# Generated by qmake (3.1) (Qt 6.2.2)
# Project:  hexview.pro
# Template: app
# Command: /usr/local/opt/qt/bin/qmake -o Makefile hexview.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = hexview1.0.0
DISTDIR = /Users/rigensen/workspace/tmp/hexview/.tmp/hexview1.0.0
...
EXPORT__QMAKE_STASH_ = /Users/rigensen/workspace/tmp/hexview/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/rigensen/workspace/tmp/hexview/hexview.pro
...
hexview.app/Contents/MacOS/hexview:  $(OBJECTS)  
	@test -d hexview.app/Contents/MacOS/ || mkdir -p hexview.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: hexview.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/macx.conf \
...
hexview.app/Contents/PkgInfo: 
	@test -d hexview.app/Contents || mkdir -p hexview.app/Contents
	@$(DEL_FILE) hexview.app/Contents/PkgInfo
	@echo "APPL????" > hexview.app/Contents/PkgInfo
hexview.app/Contents/Resources/empty.lproj: 
	@test -d hexview.app/Contents/Resources || mkdir -p hexview.app/Contents/Resources
	@touch hexview.app/Contents/Resources/empty.lproj
	
hexview.app/Contents/Info.plist: 
	@test -d hexview.app/Contents || mkdir -p hexview.app/Contents
	@$(DEL_FILE) hexview.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.hexview,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.hexview,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,hexview,g" -e "s,@LIBRARY@,hexview,g" -e "s,\$${EXECUTABLE_NAME},hexview,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >hexview.app/Contents/Info.plist

all: Makefile \
		hexview.app/Contents/PkgInfo \
		hexview.app/Contents/Resources/empty.lproj \
		hexview.app/Contents/Info.plist hexview.app/Contents/MacOS/hexview
